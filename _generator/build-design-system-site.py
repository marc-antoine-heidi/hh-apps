...
.side a:not(.on):not(:hover)>.dot{opacity:.5}
...
.ns-swatch{background-image:url(textures/texture-14-thumb.jpg)}
...
PEOPLE = [("swing-lift", "Lift", "mp4"), ("swing-behind", "Swing", "mp4"),
          ...
          ("chronicle-pocket", "Chronicle pocket", "still"),
          ("dashboard-sunlit", "Dashboard sunlit", "still"),
          ("dashboard-desk", "Dashboard desk", "still"),
          ("dashboard-handheld", "Dashboard handheld", "still"),
          ("reviewing-notes", "Reviewing notes", "still"),
