...
body{margin:0;background:#FCFAF8;color:#211217;
...
background:rgba(252,250,248,.92);backdrop-filter:blur(10px);border:1px solid rgba(33,18,23,.1)}
...
padding:10px 0;background:rgba(252,250,248,.94);backdrop-filter:blur(10px)}
...
.cin{padding:24px;background:var(--surfacePrimary);border-radius:14px;height:100%;
